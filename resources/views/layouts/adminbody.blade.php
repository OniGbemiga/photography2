...
<head>
  ...
  <!-- fullCalendar -->
  <link rel="stylesheet" href="{{secure_asset('../plugins/fullcalendar/main.min.css')}}">
  <link rel="stylesheet" href="{{secure_asset('../plugins/fullcalendar-daygrid/main.min.css')}}">
  <link rel="stylesheet" href="{{secure_asset('../plugins/fullcalendar-timegrid/main.min.css')}}">
  <link rel="stylesheet" href="{{secure_asset('../plugins/fullcalendar-bootstrap/main.min.css')}}">
</head>
...
<!-- fullCalendar 2.2.5 -->
<script src="{{secure_asset('../plugins/moment/moment.min.js')}}"></script>
<script src="{{secure_asset('../plugins/fullcalendar/main.min.js')}}"></script>
<script src="{{secure_asset('../plugins/fullcalendar-daygrid/main.min.js')}}"></script>
<script src="{{secure_asset('../plugins/fullcalendar-timegrid/main.min.js')}}"></script>
<script src="{{secure_asset('../plugins/fullcalendar-interaction/main.min.js')}}"></script>
<script src="{{secure_asset('../plugins/fullcalendar-bootstrap/main.min.js')}}"></script>
...
<!-- Filterizr-->
<script src="{{secure_asset('../plugins/filterizr/jquery.filterizr.min.js')}}"></script>
<!-- Page specific script -->
<script>
  $(function () {
