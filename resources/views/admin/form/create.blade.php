    ...
    <section class="content">
      <form action="/blogs" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
          ...
          <input type="file" id="inputName1" class="form-control" name="blog_image">
          @error('blog_image')
        ...
        <div class="form-group">
          ...
          <textarea id="inputDescription" class="form-control" rows="4" placeholder="Not more than 90 words" name="short_message">{{old('short_message')}}</textarea>
          @error('short_message')
            <small class="text-danger">{{$message}}</small>
          @enderror
        </div>
